...
class SaveIf {
 public:
  virtual ~SaveIf() {}
  virtual int32_t save_data(const std::string& username, const std::string& password, const  ::match_service::User& user1, const  ::match_service::User& user2) = 0;
};
...
class SaveNull : virtual public SaveIf {
 public:
  virtual ~SaveNull() {}
  int32_t save_data(const std::string& /* username */, const std::string& /* password */, const  ::match_service::User& /* user1 */, const  ::match_service::User& /* user2 */) override {
    int32_t _return = 0;
    return _return;
  }
};
...
typedef struct _Save_save_data_args__isset {
  _Save_save_data_args__isset() : username(false), password(false), user1(false), user2(false) {}
  bool username :1;
  bool password :1;
  bool user1 :1;
  bool user2 :1;
...
class Save_save_data_args {
 public:
  ...
  std::string username;
  std::string password;
   ::match_service::User user1;
   ::match_service::User user2;
  ...
  void __set_user1(const  ::match_service::User& val);

  void __set_user2(const  ::match_service::User& val);
...
class Save_save_data_pargs {
 public:
  ...
  const  ::match_service::User* user1;
  const  ::match_service::User* user2;
...
class SaveClient : virtual public SaveIf {
 ...
 public:
  ...
  int32_t save_data(const std::string& username, const std::string& password, const  ::match_service::User& user1, const  ::match_service::User& user2) override;
  void send_save_data(const std::string& username, const std::string& password, const  ::match_service::User& user1, const  ::match_service::User& user2);
...
class SaveMultiface : virtual public SaveIf {
 ...
 public:
  int32_t save_data(const std::string& username, const std::string& password, const  ::match_service::User& user1, const  ::match_service::User& user2) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->save_data(username, password, user1, user2);
    }
    return ifaces_[i]->save_data(username, password, user1, user2);
  }
  ...
  SaveConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  int32_t save_data(const std::string& username, const std::string& password, const  ::match_service::User& user1, const  ::match_service::User& user2) override;
  int32_t send_save_data(const std::string& username, const std::string& password, const  ::match_service::User& user1, const  ::match_service::User& user2);
