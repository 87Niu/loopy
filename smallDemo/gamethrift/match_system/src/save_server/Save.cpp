    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          xfer += this->user1.read(iprot);
          this->__isset.user1 = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 4:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          xfer += this->user2.read(iprot);
          this->__isset.user2 = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t Save_save_data_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("user1", ::apache::thrift::protocol::T_STRUCT, 3);
  xfer += this->user1.write(oprot);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("user2", ::apache::thrift::protocol::T_STRUCT, 4);
  xfer += this->user2.write(oprot);
  xfer += oprot->writeFieldEnd();
...
int32_t SaveClient::save_data(const std::string& username, const std::string& password, const  ::match_service::User& user1, const  ::match_service::User& user2)
{
  send_save_data(username, password, user1, user2);
  return recv_save_data();
}

void SaveClient::send_save_data(const std::string& username, const std::string& password, const  ::match_service::User& user1, const  ::match_service::User& user2)
{
  int32_t cseqid = 0;
...
void SaveProcessor::process_save_data(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->save_data(args.username, args.password, args.user1, args.user2);
...
int32_t SaveConcurrentClient::save_data(const std::string& username, const std::string& password, const  ::match_service::User& user1, const  ::match_service::User& user2)
{
  int32_t seqid = send_save_data(username, password, user1, user2);
  return recv_save_data(seqid);
}

int32_t SaveConcurrentClient::send_save_data(const std::string& username, const std::string& password, const  ::match_service::User& user1, const  ::match_service::User& user2)
{
